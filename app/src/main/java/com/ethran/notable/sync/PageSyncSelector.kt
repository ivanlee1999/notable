...
/**
 * The pure page-level upload decision (Phase 10-I): given a notebook's current pages and the
 ...
 * `localUpdatedAtAtSync = page.updatedAt`, an untouched page compares exactly equal and is skipped;
...
object PageSyncSelector {
    fun selectDirtyPages(
        ...
        page.updatedAt.time > row.localUpdatedAtAtSync.time
    }
}
